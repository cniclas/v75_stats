...
class IntervalInputJackpot(IntervalInput):
    ...
    def generate_html(self):
        ...
        """
        return template.format(label=self.label, property_name=self.property_name, min_value=min_value,
                              max_value_text=max_value_text, checkbox_value=checkbox_value, checkbox_checked=checkbox_checked)
